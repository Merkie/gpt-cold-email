...
<div
	...
	<p class="mb-8 text-3xl font-bold display">Register</p>
	<p class="mb-2">Name</p>
	<input
		bind:value={name}
	...
	<input
		...
		class="flex-1 outline-none bg-gray-100 border border-gray-200 p-2 rounded-md mb-8"
		type="password" />

	<button on:click={handleRegister} class="p-4 font-bold text-gray-50 bg-gray-800 rounded-md"
		>SUBMIT</button>

	<a class="mt-8 text-sm underline text-gray-500" href="/login">Already have an account?</a>
</div>
